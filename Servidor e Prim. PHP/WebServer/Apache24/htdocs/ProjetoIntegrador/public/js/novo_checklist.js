...
// usado pelo botão "Baixar / Imprimir PDF" para saber qual PDF gerar
...
btnImprimirPdf.addEventListener("click", () => {
    if (checklistIdAtual) {
        // Dispara o script de geração e download do PDF (etapa futura, ainda não construída)
        window.open(`../controllers/GerarPdfController.php?id=${checklistIdAtual}&download=1`, '_blank');
    }
});